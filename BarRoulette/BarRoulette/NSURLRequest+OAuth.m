...
+ (NSURLRequest *)requestWithHost:(NSString *)host path:(NSString *)path params:(NSDictionary *)params {
  NSURL *URL = [self _URLWithHost:host path:path queryParameters:params];
    ...
    NSString * const kConsumerKey       = [[BarrouletteKeys alloc] init].yelpkConsumerKey;
    NSString * const kConsumerSecret    = [[BarrouletteKeys alloc] init].yelpkConsumerSecret;
    NSString * const kToken             = [[BarrouletteKeys alloc] init].yelpkToken;
    NSString * const kTokenSecret       = [[BarrouletteKeys alloc] init].yelpkTokenSecret;
